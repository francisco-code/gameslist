...
Tela 1
![Web 1](https://github.com/francisco-code/assets/blob/master/gameList_tela1.PNG)

Tela 2
![Web 2](https://github.com/francisco-code/assets/blob/master/gameList_tela2.PNG)

Tela 3
![Web 3](https://github.com/francisco-code/assets/blob/master/gameList_tela3.PNG)

## Modelo conceitual
![Modelo Conceitual](https://github.com/francisco-code/assets/blob/master/modelo_dominio.PNG)
...
```bash
# clonar repositório
git clone https://github.com/francisco-code/gameslist

# executar o projeto
./mvnw spring-boot:run
```

### Exemplo do seed da base de dados import.sql
